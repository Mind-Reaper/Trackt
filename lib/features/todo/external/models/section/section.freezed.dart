...
mixin _$Section {
  ...
  SectionName get name => throw _privateConstructorUsedError;
...
abstract class $SectionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String projectId, SectionName name});
}
...
class _$SectionImpl extends _Section {
  const _$SectionImpl(
      {this.id = '', required this.projectId, required this.name})
      : super._();
  ...
  @override
  String toString() {
    return 'Section(id: $id, projectId: $projectId, name: $name)';
  }
...
abstract class _Section extends Section {
  const factory _Section(
      ...
      required final SectionName name}) = _$SectionImpl;
